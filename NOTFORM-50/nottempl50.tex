...
\piname{}               % name of PI
\piinst{}               % PI institute
\picoun{}               % PI country (ISO code: DK,FI,IS,NO,SE,..) 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Run A %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
\nrunid{ }      % Put your run id (A, B, C, ...) here
\ninstr{ }      % Put instrument name here
\ntimer{ }      % Put requested time, in numbers, with unit (N or H), e.g 5 N
\nmonth{ }      % Put preferred month(s) here
\nmoonp{ }      % Put requested moon phase here: D, G or N
