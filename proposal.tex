%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%                                                                         %%
%%               NOT PROPOSAL TEMPLATE  FOR PERIOD 50                      %%
%%                                                                         %%
%%                 USE WITH STYLEFILE: notsty50.sty                        %%
%%                                                                         %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%                                                                         %%
%%          NOT PROPOSAL TEMPLATE FILE FOR OBSERVING PERIOD 50             %%
%%                                                                         %%
...
%% the period in question. This template is only valid for period 50.      %%
%%                                                                         %%
...
%
\piname{PCSK}               % name of PI
\piinst{Stockholm Univesity, Astronomy Institute}               % PI institute
\picoun{SE}               % PI country (ISO code: DK,FI,IS,NO,SE,..) 
\piaddr{AlbaNova}               % PI postal address
...
%
\coinvest{Per Calissendorff }{Stockholm University, Astronomy Institute }  % {Name1, Institute1}   {Name2, Institute2} 
...
%
%
% All projects might be considered for execution in service mode. In case
% your project should specifically be done in either visitor or service mode, 
% please give a justification in the { } field below:
\service{Yes }
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\end{servicepage}
...
%
% Please type in the { } field below:
\techjust{20 minutes exposure each band
2 hours of spectroscopy, }
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\end{justificpage}
...
%
\NOTconfig{}{ALFOSC}{Spectro-long-slit}{Grisms\#8}
...
% the NOT director (Thomas Augusteijn, email: tau@not.iac.es) well in advance
...
% you from executing your main programme. Note that this applies for any
% programme, independent if it is to be executed in service or visitor mode
%
